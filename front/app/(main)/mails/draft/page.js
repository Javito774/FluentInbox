...
export default function Page() {
  ...
  function fetchData() {
    API(
      "/mails?filters[$and][0][estado][$eq]=draft&filters[$and][1][intrash][$eq]=0&fields[0]=id&fields[1]=asunto&fields[2]=body&fields[3]=updated_at&sort[field]=updated_at&sort[order]=DESC",
    )
